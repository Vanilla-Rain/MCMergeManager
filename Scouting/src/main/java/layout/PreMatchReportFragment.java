...
public class PreMatchReportFragment extends Fragment {
    ...
    private MatchSchedule m_schedule;
    ...
    public static PreMatchReportFragment newInstance(MatchSchedule.Match match, StatsEngine statsEngine) {
        ...
        args.putSerializable(ARG_SCHEDULE, statsEngine);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            m_schedule = (MatchSchedule) getArguments().getSerializable(ARG_SCHEDULE);
        }
    }
    ...
    private void displayOprPredection() {
        ...
        StatsEngine statsEngine = new StatsEngine(m_schedule);
        Map<Integer, Double> oprs = statsEngine.getOPRs();
